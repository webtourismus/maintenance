...
final class PostCreateProjectCommands extends DrushCommands {
  ...
  public function __construct(
    ...
    private readonly SimpleSitemapEntityManager $simpleSitemapEntityManager
  ) {
    parent::__construct();
  }
  ...
  public function createDefaultContent() {
    ...
    $node->save();
    // Create path alias manually, pathauto disabled.
    // To enable pathauto, use keyValue store
    // see https://www.drupal.org/forum/support/module-development-and-code-questions/2013-04-18/how-to-programmatically-uncheck#comment-14255898
    ...
    if ($blockConfig &&
        ...
        strpos($blockConfig->get('plugin_id'), 'block_content:' === 0)
      ) {
      $existingUuid = str_replace('block_content:', '', $blockConfig->get('plugin_id'));
